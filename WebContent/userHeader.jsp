...
<%@ page import="com.ecw.dao.*"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<head>
<title>Divyesh shop</title>
<meta charset="utf-8">
...
<body>
	...
	<div class="jumbotron text-center">
		...
		<p align="center"
			style="color: blue; font-weight: bold; margin-top: 15px; margin-bottom: -15px;"
			id="message"></p>
	</div>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="cartDetails.jsp"
					style="margin: 0px; padding: 0px;" id="mycart"><i
						class="fa fa-shopping-cart fa-3x icon-white"
						style="background-color: #333; margin: 0px; padding: 0px; margin-top: 5px;">
					</i>Cart</a></li>
				<%
					} else {
				%>
