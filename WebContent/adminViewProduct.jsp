...
<%@ page import="com.ecw.dao.*,com.ecw.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*" %>
  ...
  <div class="col-sm-4">
    <div class="thumbnail">
      ...
      <form method="post">
      	...
      	<button type="submit" formaction="./UpdateProductSrv?prodid=<%=product.getProdId() %>">Update Product</button>
      </form>
    </div>
  </div>
