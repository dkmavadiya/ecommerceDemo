...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>" + "<h2 style='color:red;'>Welcome to Divyesh shop</h2>"
				+ "" + "Hi " + name + "," + "<br><br>Thanks for singing up with Divyesh shop .<br>"
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "ecw500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Divyesh shop";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Divyesh shop!" + "<br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Divyesh shop.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at Divyesh shop";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Divyesh shop!" + "<br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Divyesh shop.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
